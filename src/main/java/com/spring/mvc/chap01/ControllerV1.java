...
public class ControllerV1 {
    ...
    // 스프링에서는 메서드 별로 url을 매핑하여 처리합니다.
//    @RequestMapping(value = "/food", method = RequestMethod.GET)
    @GetMapping("/food")
    public String food() {
        // 리턴문에는 어떤 jsp 파일로 포워딩할지 경로를 적습니다.
...
*/
    ...
    // 2. @RequestParam 사용하기
    // 파라미터 변수명과 매개 변수명을 동일하게 맞추면 @RequestParam을 생략할 수 있다.
/*
    @PostMapping("/food")
 ...
 */
    ...
    // 처리해야 할 파리미터의 양이 많거나, 서로 연관되어 있는 데이터인 경우 사용.
    @PostMapping("/food")
