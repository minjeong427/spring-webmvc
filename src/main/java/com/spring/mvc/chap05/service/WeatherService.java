...
public class WeatherService {
    ...
    public void getShortTermForecast(String area1, String area2) {
        ...
        try {
            ...
            urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "ixkMZWJPfqsUEak2Mn6AYPX0N15hXStiMaBhqiyo55S1zsxf%2FyHf%2FsYbgVQzKUQwDVKsJVis7pFd%2BX%2BGbdpJHw%3D%3D"); /*Service Key*/
