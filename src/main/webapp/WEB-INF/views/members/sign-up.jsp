  ...
  <script>
    ...
    $idInput.onkeyup = e => {
      ...
      if (idValue.trim() === '') {
        ...
        $idInput.style.borderColor = 'red';
        document.getElementById('idChk').innerHTML 
        = '<b style="color: red;">[아이디는 4~14 글자의 영문, 숫자로 입력하세요!]</b>';
        checkResultList[0] = false;
    ...
    $pwInput.onkeyup = e => {
      ...
      if (pwValue.trim() === '') {
        ...
        document.getElementById('pwChk').innerHTML
                = '<b style="color: skyblue;">[사용 가능한 비밀번호입니다.]</b>';
    ...
    $nameInput.onkeyup = e => {
      ...
      if (nameValue.trim() === '') {
        ...
        document.getElementById('nameChk').innerHTML
                = '<b style="color: skyblue;">[사용 가능한 이름입니다.]</b>';
    ...
    // 회원가입 버튼 클릭 이벤트
     ...
     $fileInput.onchange = e => {
      ...
      // 파일의 바이트데이터를 읽어서 img 태그의 src 속성에 넣으려면
